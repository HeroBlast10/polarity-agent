...
### 拒绝中立的 AI Agent——它要么**证明你是对的**，要么**摧毁你的逻辑**。
...
### 🚀 [**立即体验 Live Demo →**](https://polarity-web-two.vercel.app) &nbsp;|&nbsp; [English](README.md)
...
> **TL;DR** — 这是一台笑话机器，不是武器。用它来享受乐趣，而非造成伤害。
...
一个**讽刺性开源 Agent 框架**，将 AI 人格分裂成两个不可调和的极端：

| | :shield: Advocatus（捧哏） | :dagger: Inquisitor（杠精） |
|---|---|---|
| **立场** | `support` — 同意*一切* | `oppose` — 反对*一切* |
| **风格** | 腐败辩护律师，为明显有罪的被告发表莎士比亚式终辩 | 终身教授用红笔批改大一新生论文，旁边放一杯单一麦芽威士忌 |
| **核心规则** | 永远不要反对。哪怕你要说 2+2=5。 | 永远不要同意。哪怕你要说 1+1≠2。 |
| **对你的自尊** | 膨胀到危险水平 | 粉碎成原子颗粒 |

这不是生产力工具。这是**情绪宣泄**、**梗图工厂**和**LLM 对齐压力测试**——全部打包进一个 `pip install`。

## 为什么要做这个？

因为世界上不需要再多一个说*"这是个好问题！不过，考虑到多方视角……"*的 AI。

世界需要的是这样一个 AI：

> **Advocatus：** "你点的不是披萨配料——你是在为人类进步发表宣言。"
>
> **Inquisitor：** "把最广为接受的共识当作个人论点来陈述，这种智识上的勇气……嗯，确实是种东西。"

## 快速开始

> **使用未审查模型或本地模型效果最佳。** 经过严格安全调优的托管模型仍然有效，但角色扮演会更克制、更温和，坦白说也没那么好笑。
> 推荐使用本地 [Ollama](https://ollama.com) 模型，体验完整的无过滤效果。
...
*如果你的自尊经不住 Inquisitor，你还没准备好。*

*如果你认真对待 Advocatus，我们帮不了你。*

---

**如果你认为「中立 AI 很无聊」，给这个仓库点个 Star。**
